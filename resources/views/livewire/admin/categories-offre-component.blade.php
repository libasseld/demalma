            ...
            <div class="panel">
                ...
                <div class="w-full md:w-1/3">
                    ...
                    <div class="w-full p-2">
                        <label for="name" class="block mb-2 text-sm font-mediu">name</label>
                        <input type="text" wire:model="categorie_offre.name" id="name" class="bg-white border border-slate-500 text-slate-900 placeholder-slate-700 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 block w-full p-2.5 dark:bg-slate-100 dark:border-slate-400" placeholder="name">
