...
<head>
    <title> Réservation Demalma </title>
    <!--[if !mso]><!-- -->
...
<body style="background-color:#54595f;">
    <div
        ...
        Votre réservation a été enregistrée </div>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:300;line-height:20px;text-align:left;color:#000000;">
                                                   Vous avez reçu un nouveau message en proovennace du site 
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:16px;font-weight:700;line-height:20px;text-align:left;color:#000000;">
                                                   <u>Détails du message </u>:
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    © {{date('Y')}} Demalma, 29 rue Mohamed V plateau, <br />Dakar, Sénégal
                                                </div>
                                            </td>
                                        </tr>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td
                                                                                ...
                                                                                <a href="https://web.facebook.com/profile.php?id=100084478654305&locale=ms_MY" target="_blank"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td
                                                                                style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                                                                                <a href="https://www.instagram.com/elitescars_location/" target="_blank"
                                                                                    style="color: #0078be; text-decoration: none; font-weight: 500;">
